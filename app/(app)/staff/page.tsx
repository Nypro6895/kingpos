      ...
      {searched && lookupResult?.status === "found" ? (
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <AvatarInitials
              imageUrl={safeAccountAvatarUrl(lookupResult.account.avatar_url)}
              ...
              >
                <td className="px-4 py-4 align-top">
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    <AvatarInitials
                      imageUrl={member.staff_profile_avatar_url}
...
function StaffDetailDrawer({
  ...
  const bookingReadiness = bookingSetup.readinessByStaffId[member.id] ?? null;
  ...
  return (
    <StaffSlideOver
      ...
      title={member.staff_profile_display_name}
    >
      <div className="flex items-center gap-3">
        <AvatarInitials
          imageUrl={member.staff_profile_avatar_url}
          name={member.staff_profile_display_name}
        />
        <div>
      ...
      <DetailSection title="Staff Profile">
        ...
        <DetailField
          ...
          value={cleanValue(member.first_name) || "No first name"}
        />
        <DetailField
          label="Real last name"
          value={cleanValue(member.last_name) || "No last name"}
        />
        <DetailField
          label="Role / title"
      ...
      <DetailSection title="Services and Availability">
        <DetailField
          label="Services"
          value={
            bookingReadiness
              ? `${bookingReadiness.onlineAssignedServiceCount} online / ${bookingReadiness.assignedServiceCount} assigned`
              : "No assignment data"
          }
        />
        <DetailField
          ...
          value={
            bookingReadiness
              ? `${bookingReadiness.workingRuleCount} working rules`
        ...
        <DetailField
          ...
          value={
            bookingReadiness
              ? `${bookingReadiness.upcomingBlockCount} upcoming`
              : "No block data"
          }
        />
        <DetailField
