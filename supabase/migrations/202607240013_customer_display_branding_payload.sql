alter table public.pos_settings
  ...
  alter column customer_promo_body set default 'Enter your phone number to earn points and rewards',
  alter column customer_left_ad_text set default 'More beauty, more rewards on the Reylumi app',
  alter column customer_right_ad_text set default 'Earn points every visit. Exclusive offers for app members. Book appointments faster.';
...
begin
  ...
  return jsonb_build_object(
    ...
    'customerLeftAdText', coalesce(setting_row.customer_left_ad_text, 'More beauty, more rewards on the Reylumi app'),
    'customerRightAdText', coalesce(setting_row.customer_right_ad_text, 'Earn points every visit. Exclusive offers for app members. Book appointments faster.'),
    'customerPromoTitle', coalesce(setting_row.customer_promo_title, 'Welcome back!'),
    'customerPromoBody', coalesce(setting_row.customer_promo_body, 'Enter your phone number to earn points and rewards'),
