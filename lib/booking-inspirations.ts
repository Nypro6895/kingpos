...
export const BOOKING_INSPIRATION_SELECT =
  "id, organization_id, salon_id, booking_id, booking_line_id, source_type, source_content_id, source_salon_id, source_media_asset_id, source_media_bucket, source_media_path, source_media_width, source_media_height, source_media_mime_type, credited_staff_id, service_id, source_title_snapshot, source_caption_snapshot, source_booking_note_snapshot, service_name_snapshot, credited_staff_name_snapshot, salon_name_snapshot, metadata, created_at, updated_at";
